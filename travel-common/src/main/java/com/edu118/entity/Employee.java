...
public class Employee implements Serializable {
	 ...
	 * 员工id，登陆用的用户名
	 */
	@Pattern(regexp = "^[a-zA-Z]\\w{3,12}$", message = "您提供的用户名格式错误！", 
			groups = { ILoginGroups.class })
	private String eid;
	/**
	 * 职务id
	 */
	 ...
	 * 登陆密码
	 */
	@Pattern(regexp = "^[a-zA-Z]\\w{5,17}$", message = "您提供的用户密码格式错误！", 
			groups = { ILoginGroups.class , IAddGroups.class})
