...
public class BaseController {
	...
	protected final static String BASE_PATH = "https://localhost/user/";
	
	protected Logger logger = LogManager.getLogger(BaseController.class);
	
	//请求参数的验证，统一的处理方法
	@ExceptionHandler(BindException.class)
	public String bindException(BindingResult bind , HttpServletRequest request ,
	...
	private String  getBasePath(HttpServletRequest request) {
		...
		System.out.println("基本请求路径="+sb.toString());
		return sb.toString();
	}
	/**
	 * 是否是Ajax请求
